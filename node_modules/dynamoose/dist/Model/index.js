...
function createTableRequest(model) {
    return __awaiter(this, void 0, void 0, function* () {
        return Object.assign(Object.assign({ "TableName": model.name }, utils.dynamoose.get_provisioned_throughput(model.options)), yield model.getCreateTableAttributeParams());
    });
}
        ...
        if (updateAll || model.options.update.includes(ModelUpdateOptions.indexes)) {
            ...
            yield updateIndexes.reduce((existingFlow, index) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (index.type === index_changes_1.ModelIndexChangeType.add) {
                    params.AttributeDefinitions = (yield model.getCreateTableAttributeParams()).AttributeDefinitions;
...
class Model {
    ...
    getIndexes() {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield Promise.all(this.schemas.map((schema) => schema.getIndexes(this)))).reduce((result, indexes) => {
            ...
            return ({
                "RequestItems": {
                    [this.name]: yield Promise.all(documents.map((document) => __awaiter(this, void 0, void 0, function* () {
                        return ({
                            "PutRequest": {
                                "Item": yield new this.Document(document).toDynamo({ "defaults": true, "validate": true, "required": true, "enum": true, "forceDefault": true, "saveUnknown": true, "combine": true, "customTypesDynamo": true, "updateTimestamps": true, "modifiers": ["set"] })
                            }
                        });
                    })))
                }
    ...
    update(keyObj, updateObj, settings, callback) {
        ...
        const getUpdateExpressionObject = () => __awaiter(this, void 0, void 0, function* () {
            ...
            const returnObject = yield Object.keys(updateObj).reduce((accumulatorPromise, key) => __awaiter(this, void 0, void 0, function* () {
                ...
                for (let i = 0; i < valueKeys.length; i++) {
                    ...
                    if (subValue !== dynamooseUndefined) {
                        const defaultValue = yield schema.defaultCheck(subKey, undefined, updateType.objectFromSchemaSettings);
                        if (defaultValue) {
                    ...
                    if (updateType.objectFromSchemaSettings.required === true) {
                        yield schema.requiredCheck(subKey, undefined);
                    }
                ...
                const defaultObjectFromSchema = yield this.Document.objectFromSchema(yield this.Document.prepareForObjectFromSchema({}, this, documentFunctionSettings), this, documentFunctionSettings);
            ...
            yield Promise.all(schema.attributes().map((attribute) => __awaiter(this, void 0, void 0, function* () {
                const defaultValue = yield schema.defaultCheck(attribute, undefined, { "forceDefault": true });
